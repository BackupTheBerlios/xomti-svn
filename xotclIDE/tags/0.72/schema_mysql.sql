CREATE TABLE Object (
  objectid int DEFAULT '0' NOT NULL auto_increment,
...
CREATE TABLE Method (
  methodid int DEFAULT '0' NOT NULL auto_increment,
  timest TIMESTAMP(14) DEFAULT NULL,
  versioninfo varchar(30),
  name varchar(50),
  category varchar(50),
...
CREATE TABLE Component (
  componentid int DEFAULT '0' NOT NULL auto_increment,
  timest TIMESTAMP(14) DEFAULT NULL,
  versioninfo varchar(30),
  isclosed bool DEFAULT 0,
  name varchar(50),
...
CREATE TABLE Userlib (
  userid int DEFAULT '0' NOT NULL auto_increment,
  name varchar(30),
  longname varchar(60),
  PRIMARY KEY (userid)
);
CREATE TABLE Info (
  infoid int DEFAULT '0' NOT NULL auto_increment,
  infotext text,
  PRIMARY KEY (infoid)
);
CREATE TABLE Configmap (
  configmapid int DEFAULT '0' NOT NULL auto_increment,
  name varchar(50),
  timest TIMESTAMP(14) DEFAULT NULL,
  versioninfo varchar(30),
  isclosed bool DEFAULT 0,
