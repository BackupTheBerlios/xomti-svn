...
Class instproc getHeritage {} {
	...
	if {$sclass=="::Object" || $sclass=="::xotcl::Object"} continue
...
Object instproc hasMetadataNotEmpty key {
    expr {[my hasMetadata $key] && [my set _idemeta($key)]!=""}
}
...
IDEMetadataAnalyzer instproc unknown {args} {
    if {[llength $args]==4 && [lindex $args 1]=="idemeta" && [Object isobject [lindex $args 0]]} {
